...
module Feedjira
  module Parser
    class AtomYoutubeEntry
      ...
      element :"media:thumbnail[0].to_s", as: :image, value: :url
      element :"media:thumbnail", as: :image_width, value: :width
      element :"media:thumbnail", as: :image_height, value: :height
